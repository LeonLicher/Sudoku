...
```
cd existing_repo
git remote add origin https://git.fh-muenster.de/ll609274/sudoku.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fh-muenster.de/ll609274/sudoku/-/settings/integrations)
